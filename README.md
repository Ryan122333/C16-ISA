...
|--------|--------|----------|-------------|
| 0x0    | 0000   | LDR R, [Rp] | Load word from memory at the exact address stored in register Rp into R |
| 0x1    | 0001   | STR R, [Rp] | Store word from R into memory at the exact address stored in register Rp |
